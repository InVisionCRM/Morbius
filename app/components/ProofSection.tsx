        ...
        <div className="relative w-full max-w-5xl h-[60vh]">
          {PROOF_ITEMS.map((item, index) => {
            ...
            return (
              <article
                key={item.src}
                className="absolute inset-0 border border-white/10 rounded-3xl overflow-hidden shadow-2xl"
                style={{
                  opacity: fade,
              ...
              >
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-black/70 py-6 px-6">
                    <div className="space-y-2">
                      <p className="text-xs uppercase tracking-[0.4em] text-purple-300">Exhibit {index + 1}</p>
                      ...
                      {item.subtitle && <p className="text-gray-300">{item.subtitle}</p>}
