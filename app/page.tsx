        ...
        <div className="flex items-center px-6 py-4">
          ...
          <div className="flex-1">
            <button
              ...
              className="px-4 py-2 bg-lime-600/50 hover:bg-lime-600/70 rounded-lg transition-colors text-white font-medium"
            >
              Switch
            </button>
          </div>
        ...
        <div className="relative z-10 flex items-center justify-center gap-2 px-6">
          {letters.map((letter, i) => {
            return (
              <div
                key={i}
                className="text-9xl font-black bg-gradient-to-r from-purple-800 to-purple-950 bg-clip-text text-transparent"
                style={{
                  opacity: 1,
